...
const MPH_BOOKING_FORM =
  'https://docs.google.com/forms/d/e/1FAIpQLScNKDddgzz6tgKza9XZJmSPjZi9b93du3ZFRYeRbnZEZCO2gQ/viewform?embedded=true';
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-24 relative z-10">
          <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mt-10 rounded-2xl bg-gray-50 ring-1 ring-black/5 overflow-hidden">
                <div className="p-6 md:p-8 border-b border-gray-200">
                  <h3 className="text-xl font-semibold text-gray-900 mb-1">Enquiry / Booking Form</h3>
                  <p className="text-sm text-gray-500">Fill out the form and we&apos;ll get back to you.</p>
                </div>
                <iframe
                  src={MPH_BOOKING_FORM}
                  title="Enquiry / Booking Form - Multi-Purpose Hall"
